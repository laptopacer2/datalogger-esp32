...
typedef enum
{
    ...
    CALIBRATION_SENSOR_5_UNIT_CHANGED,
    CALIBRATION_SENSOR_6_UNIT_CHANGED,
    CALIBRATION_SENSOR_7_UNIT_CHANGED,
    CALIBRATION_SENSOR_8_UNIT_CHANGED,

    CALIBRATION_SENSOR_5_UNITPS_CHANGED,
    CALIBRATION_SENSOR_6_UNITPS_CHANGED,
    CALIBRATION_SENSOR_7_UNITPS_CHANGED,
    CALIBRATION_SENSOR_8_UNITPS_CHANGED,
