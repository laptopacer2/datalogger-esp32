...
void dial_big_data_done_2_cb(dialbig_data_t new_real)
{
    ...
    {
        {
            ...
            msg_t msg;
            msg.type = EXTERNAL_SENSOR_6_UNIT_CHANGED;
...

        {
            ...
            msg_t msg;
            msg.type = EXTERNAL_SENSOR_6_UNITPS_CHANGED;
